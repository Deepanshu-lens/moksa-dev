...
>
  <!-- Selecting Tabs -->
  <div
    class="flex items-center justify-center rounded-lg border-black/[.13] dark:border-neutral-700 border-solid border-[1px] p-1 lg:w-[540px] w-[90vw] h-[40px] mx-auto mb-10"
  >
    <button
      on:click={() => (selected = 1)}
  ...
  {#if selected === 1}
    <div
      class="lg:w-[94.5%] w-[90vw] my-4 pt-8 shad mx-6 border-black/[.08] border-[1px] border-solid"
    >
      ...
      />
      <form
        class="flex lg:flex-row flex-col items-center justify-center gap-4 w-[75%] mb-8 px-6"
      >
  ...
  {#if selected === 2}
    ...
    >
      ...
      />
      <form
        class="flex lg:flex-row flex-col items-start justify-center gap-4 w-[65%] mb-8 px-6"
      >
