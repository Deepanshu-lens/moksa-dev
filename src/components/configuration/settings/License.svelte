...
>
  <div
    class="w-[90vw] lg:w-[94.5%] my-4 pt-8 shad mx-6 border-black/[.08] border-[1px] border-solid flex flex-col"
  >
    <div
    ...
    <form
      class="flex lg:flex-row flex-col items-center justify-center gap-4 w-[75%] mb-8 px-8"
    >
